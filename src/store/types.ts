...
export const SET_TASK_TO_DELETE = 'SER_TASK_TO_DELETE';
export const UNSET_TASK_TO_DELETE = 'UNSET_TASK_TO+DELETE';
...
export type ListsAction = AddListAction | GetListAction | GetListByIdAction | SetListIdToDeleteAction | 
SetListToEditAction | DeleteListAction | UpdateListAction | SetSelectedListAction | AddTtaskAction | DeleteTaskAction | 
